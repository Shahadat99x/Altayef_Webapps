        ...
        <Section variant="slate" className="relative overflow-hidden">
            ...
            <Reveal>
                <SectionHeader
                    ...
                    description="We have successfully helped thousands of candidates reach their destinations."
                    centered
                />
            </Reveal>
            ...
            {testimonials.length === 0 ? (
                ...
                <Stagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 relative z-10">
                    {testimonials.slice(0, 3).map((t) => (
                        <StaggerItem key={t._id?.toString()}>
                            <Card className="p-6 sm:p-8 flex flex-col h-full hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
                                <div className="mb-5">
                                    ...
                                    <blockquote className="text-slate-700 leading-relaxed italic text-sm sm:text-base line-clamp-4">
                                        &quot;{t.quote}&quot;
                                    </blockquote>
                                </div>

                                <div className="mt-auto flex items-center gap-3 pt-5 border-t border-slate-100">
                                    <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 font-bold overflow-hidden shrink-0">
                                        {t.authorPhotoUrl ? (
            ...
            <Reveal className="text-center mt-10 relative z-10">
                <Link href="/about/testimonials" className="text-blue-600 font-semibold hover:text-blue-700 hover:-translate-y-0.5 transition-all inline-flex items-center gap-1">
                    Read More Reviews
