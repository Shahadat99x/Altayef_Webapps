    ...
    return (
        <Section variant="slate" className="relative overflow-hidden">
            ...
            {testimonials.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
                    {testimonials.slice(0, 3).map((t) => (
                        <Card key={t._id?.toString()} className="p-8 flex flex-col h-full hover:-translate-y-1 transition-transform duration-300">
                            <div className="mb-6">
            ...
            <div className="text-center mt-12 relative z-10">
                <Link href="/about/testimonials" className="text-blue-600 font-semibold hover:text-blue-700">
