            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="max-w-2xl text-center lg:text-left mx-auto lg:mx-0">
                        ...
                        <Reveal delay={0.3}>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                                <Link
                                    href="/contact"
                                    className="rounded-xl bg-blue-600 px-8 py-4 text-base font-bold text-white shadow-lg hover:bg-blue-700 hover:shadow-blue-500/25 hover:-translate-y-0.5 transition-all active:scale-95"
                                >
                                    Book Consultation
                                </Link>
                                {license?.whatsapp && (
                                    <a
                                        ...
                                        className="rounded-xl bg-white px-8 py-4 text-base font-bold text-slate-700 shadow-sm ring-1 ring-slate-200 hover:bg-slate-50 hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2"
                                    >
                    ...
                    <Reveal delay={0.2} className="relative mx-auto w-full max-w-lg lg:mx-0">
                        ...
                        <div className="bg-white border border-slate-100 rounded-2xl shadow-xl p-8 relative overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-green-500"></div>

                            <div className="flex items-start justify-between mb-8">
                                <div>
                                    <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-wider">Agency Status</h3>
                                    <div className="mt-1 flex items-center gap-2">
                                        ...
                                        <span className="font-bold text-slate-900">Active & Verified</span>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-wider">License No</h3>
                                    <p className="mt-1 font-mono font-bold text-xl text-slate-900 tracking-wide">
                                        {license?.licenseNumber || 'RL-XXXX'}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 border-t border-slate-100 pt-6 mb-8">
                                <div className="flex items-center gap-3 text-slate-700">
                                    <svg className="w-5 h-5 text-blue-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                                    <span className="text-sm font-medium">Ministry of Expatriates Approved</span>
                                </div>
                                <div className="flex items-center gap-3 text-slate-700">
                                    <svg className="w-5 h-5 text-blue-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                                    <span className="text-sm font-medium">Saudi Embassy Authorized</span>
                                </div>
                                <div className="flex items-center gap-3 text-slate-700">
                                    <svg className="w-5 h-5 text-blue-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                                    <span className="text-sm font-medium">BMET Registered Partner</span>
                                </div>
                            </div>

                            <Link
                                href="/verify-license"
                                className="block w-full py-3 px-4 bg-slate-50 border border-slate-200 text-slate-600 font-semibold rounded-lg text-center hover:bg-slate-100 transition-colors"
                            >
                                Verify Our License
                            </Link>
