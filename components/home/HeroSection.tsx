                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="max-w-2xl text-center lg:text-left mx-auto lg:mx-0">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <Link
                                href="/contact"
                                className="rounded-xl bg-blue-600 px-8 py-4 text-base font-bold text-white shadow-lg hover:bg-blue-700 hover:shadow-blue-500/25 transition-all active:scale-95"
                            >
                                Book Consultation
                            </Link>
                            {license?.whatsapp && (
                                <a
                                    ...
                                    className="rounded-xl bg-white px-8 py-4 text-base font-bold text-slate-700 shadow-sm ring-1 ring-slate-200 hover:bg-slate-50 transition-all flex items-center justify-center gap-2"
                                >
                    ...
                    <div className="relative mx-auto w-full max-w-lg lg:mx-0">
                        ...
                        <div className="bg-white border border-slate-100 rounded-2xl shadow-xl p-8 relative overflow-hidden">
