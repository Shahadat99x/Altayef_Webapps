        ...
        <Section variant="white">
            <Reveal>
                <div className="flex flex-col sm:flex-row justify-between items-end mb-12 gap-4">
                    ...
                    <Link href="/knowledge-center" className="text-blue-600 hover:text-blue-700 font-bold inline-flex items-center hover:-translate-y-0.5 transition-transform">
                ...
                <Stagger className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {articles.map((article) => (
                        <StaggerItem key={article._id?.toString()}>
                            <Card href={`/knowledge-center/${article.category}/${article.slug}`} hoverEffect className="flex flex-col h-full p-0">
