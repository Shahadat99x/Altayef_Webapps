    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center mb-16">
                <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl">Client Stories</h1>
            ...
            {testimonials.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {testimonials.map((t) => (
                        <div key={t._id?.toString()} className={`bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col h-full ${t.featured ? 'ring-2 ring-blue-500' : ''}`}>
                            <div className="flex-1">
                                <svg className="h-8 w-8 text-blue-200 mb-4" fill="currentColor" viewBox="0 0 24 24">
