                    ...
                    <div className="space-y-12">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div className="bg-green-50 p-6 rounded-xl border border-green-100">
                                <h3 className="font-bold text-lg text-green-900 mb-2">Quick Contact</h3>
                                <p className="text-green-800 space-y-1">
                        ...
                        {/* Map Embed */}
                        <div className="h-80 bg-gray-100 rounded-xl overflow-hidden shadow-inner border border-gray-200 relative">
                            ...
                            ></iframe>
                            <div className="absolute inset-x-0 bottom-0 bg-white/90 backdrop-blur-sm p-2 text-center text-xs text-gray-500">
