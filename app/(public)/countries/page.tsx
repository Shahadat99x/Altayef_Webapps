                        ...
                        {featured.map(country => (
                            ...
                            >
                                <div className="absolute inset-0 bg-slate-900">
                                    {/* Placeholder for real images - using patterns/gradients for now */}
                                    <div className={`w-full h-full transition-transform duration-700 group-hover:scale-110 ${country.name.includes('Saudi') ? 'bg-emerald-900' : 'bg-blue-900'}`}>
                                        {/* Fallback pattern */}
