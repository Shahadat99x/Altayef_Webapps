                ...
                <div className="space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <a
                            ...
                            className="flex-1 inline-flex items-center justify-center gap-3 bg-emerald-500 text-white px-6 py-4 rounded-xl font-bold text-lg hover:bg-emerald-600 transition shadow-lg hover:shadow-emerald-500/30 transform hover:-translate-y-0.5"
                        >
                        ...
                        <a
                            ...
                            className="flex-1 inline-flex items-center justify-center gap-3 bg-white text-slate-700 border border-slate-200 px-6 py-4 rounded-xl font-bold text-lg hover:bg-slate-50 transition shadow-sm hover:shadow-md transform hover:-translate-y-0.5"
                        >
